...
def parse():
    ...
    parser = argparse.ArgumentParser(
        ...
        usage='RNN_PULB.py --method <string> --label_mechanism <string> --dataset_name <string>' +
    ...
    parser.add_argument('--method', type=str, default='RNN-PULB', choices=['RNN-PULB'],
