...
def parse():
    ...
    parser = argparse.ArgumentParser(
        ...
        usage='CNN_PULB.py --method <string> --label_mechanism <string> --dataset_name <string>' +
    ...
    parser.add_argument('--method', type=str, default='CNN-PULB', choices=['CNN-PULB'],
    ...
    parser.add_argument('--dataset_name', type=str, default='006', help='The filename of experiment dataset.')
...
if __name__ == '__main__':
    ...
    # Label mechanism
    X_train, Y_train, L_train, X_test, Y_test = label_mechanism_raw(data, label, data_pro,
                                                                    positive_num=args.label_number,
    ...
    for i in range(args.runs):
        ...
        start_time = clock()
        punn = PUNN(input_dims=[X_train.shape[1], X_train.shape[2]], act_fun=args.act_func, l2_parameter=args.l2_weight)
        if i == 0:
            punn.model.summary()
        punn.compile(optimizer='adam')
