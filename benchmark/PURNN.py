...
class PUNN(object):
    def __init__(self,
        ...
        self.model.add(Dense(1, name='label_prediction', activation=act_fun,
        ...
        self.RNN = LSTM(20, input_shape=self.input_dims, activation='relu', name='lstm_1', return_sequences=True)
        self.RNN = LSTM(10, input_shape=self.input_dims, activation='relu', name='lstm_2')(self.RNN)
        self.probability = Dense(1, name='label_prediction', activation=act_fun,
                                    kernel_regularizer=regularizers.l2(self.l2_para),
                                    bias_regularizer=regularizers.l2(self.l2_para))(self.RNN)
